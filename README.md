# Awesome JavaScript Interviews with stars
...
* [undefined-vs-not\_defined](Javascript/undefined-vs-not_defined.md)
...
* [sequential-execution-fundamental\_working-THEORY](Promise-Async-Await-Sequential-Execution/sequential-execution-of-codes-React-Node-Context-Master-Notes/sequential-execution-fundamental_working-THEORY.md)
...
* [bodyParser\_what-does-it-do](Node-Express/bodyParser_what-does-it-do.md)
...
* [cors\_Why\_its\_needed](Node-Express/cors_Why_its_needed.md)
...
* [destructuring\_basics-js](React/destructuring_basics-js.md)
* [More destructuring\_example](React/destructuring_example.md)
* [More Destructuring explanations and examples](React/Destructuring_General.md)
* [destructuring\_in\_react-1](React/destructuring_in_react-1.md)
* [More destructuring\_in\_react](React/destructuring_in_react-2.md)
...
* [ngOnChanges-SimpleChanges\_interface](Angular-Topics-Interview/Life-Cycle-Hooks/ngOnChanges-SimpleChanges_interface.md)
...
* [subscribe\_pattern-with-take(1)](Angular-Topics-Interview/rx-js/best-practices-common-pattern/subscribe_pattern-with-take\(1\).md)
* [Best Practice - when\_using\_async\_pipe\_no\_need\_to\_unsubscribe](Angular-Topics-Interview/rx-js/best-practices-common-pattern/when_using_async_pipe_no_need_to_unsubscribe.md)
...
* [ControlValueAccessor\_basics](Angular-Topics-Interview/ControlValueAccessor_basics.md)
...
* :link: [coding-interview-university](https://github.com/jwasham/coding-interview-university) ⭐ 358,888 | 🐛 123 | 📅 2025-08-28
* :link: [best javascript-algorithms github repo](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,470 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26
* :link: [Front-end-Developer-Interview-Questions](https://github.com/h5bp/Front-end-Developer-Interview-Questions) ⭐ 60,880 | 🐛 63 | 🌐 Nunjucks | 📅 2026-06-16
* :link: [reactjs-interview-questions](https://github.com/sudheerj/reactjs-interview-questions) ⭐ 44,731 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-13
* :link: [front-end-interview-handbook](https://github.com/yangshun/front-end-interview-handbook) ⭐ 43,987 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-13 - Almost complete answers to "Front-end Job Interview Questions" which you can use to interview potential candidates, test yourself or completely ignore
* :link: <https://github.com/amejiarosario/dsa.js-data-structures-algorithms-javascript> ⭐ 7,773 | 🐛 8 | 🌐 JavaScript | 📅 2024-01-30
* :link: [sorting-algorithms-in-javascript](https://github.com/benoitvallon/computer-science-in-javascript/tree/master/sorting-algorithms-in-javascript) ⭐ 2,591 | 🐛 16 | 🌐 JavaScript | 📅 2023-08-09
...
* :link: [Karp\_algorithm](https://www.wikiwand.com/en/Rabin%E2%80%93Karp_algorithm)
...
* :link: [javascript-interview-questions](https://github.com/sudheerj/javascript-interview-questions) ⭐ 27,593 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-01
...
* :link: [javascript-Exercises](https://github.com/kolodny/exercises) ⭐ 4,213 | 🐛 10 | 🌐 JavaScript | 📅 2017-10-03
* :link: [interview-questions-in-javascript](https://github.com/kennymkchan/interview-questions-in-javascript) ⭐ 3,622 | 🐛 4 | 📅 2019-09-30
...
* :link: [js--interview-questions](https://github.com/vvscode/js--interview-questions) ⭐ 1,412 | 🐛 3 | 📅 2022-10-27
* :link: [Algorithms-Leetcode-Javascript](https://github.com/ignacio-chiazzo/Algorithms-Leetcode-Javascript) ⭐ 753 | 🐛 10 | 🌐 JavaScript | 📅 2026-03-20
...
* :book: [You-Dont-Know-JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,673 | 🐛 2 | 📅 2026-02-15
* :link: [Super useful es6-cheatsheet](https://github.com/DrkSephy/es6-cheatsheet) ⭐ 13,326 | 🐛 7 | 🌐 JavaScript | 📅 2022-10-08
...
* :link: [developer.mozilla.org/JavaScript/A\_re-introduction\_to\_JavaScript](https://developer.mozilla.org/en-US/docs/Web/JavaScript/A_re-introduction_to_JavaScript)
...
* :link: <https://github.com/Chalarangelo/30-seconds-of-code> ⭐ 128,722 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-08 - Curated collection of useful Javascript snippets that you can understand in 30 seconds or less.

* :link: [Many tricky and common javascript-questions](https://github.com/lydiahallie/javascript-questions) ⭐ 65,319 | 🐛 54 | 📅 2024-08-04
...
* :link: <https://www.thatjsdude.com/interview/js1.html> - JS: Interview Algorithm Part-1

* :link: <https://www.thatjsdude.com/interview/js2.html> - JS: Basics and Tricky Questions Part-2: intermediate

* :link: <https://www.thatjsdude.com/interview/dom.html> - JS: Interview Questions Part-3

* :link: <https://medium.freecodecamp.org/3-questions-to-watch-out-for-in-a-javascript-interview-725012834ccb> - 3 JavaScript questions to watch out for during coding interviews

* :link: <https://medium.com/dev-bits/a-perfect-guide-for-cracking-a-javascript-interview-a-developers-perspective-23a5c0fa4d0d> - A perfect guide for cracking a JavaScript interview - A developer’s perspective
...
* :link: <https://medium.com/javascript-scene/master-the-javascript-interview-what-is-a-closure-b2f0d2152b36> - Master the JavaScript Interview: What is a Closure?

* :link: <https://medium.com/javascript-scene/master-the-javascript-interview-what-is-function-composition-20dfb109a1a0> - Master the JavaScript Interview: What is Function Composition?

* :link: <https://medium.com/javascript-scene/common-misconceptions-about-inheritance-in-javascript-d5d9bab29b0a> - Common Misconceptions About Inheritance in JavaScript

* :link: <https://dev.to/arnavaggarwal/10-javascript-concepts-you-need-to-know-for-interviews?utm_source=hashnode.com> - 10 JavaScript concepts you need to know for interviews

* :link: <https://hackernoon.com/a-quick-introduction-to-functional-javascript-7e6fe520e7fa> - A Quick Introduction to Functional Javascript

* :link: <https://www.toptal.com/javascript/interview-questions> - 37 Essential JavaScript Interview Questions

* :link: <https://medium.com/coderbyte/a-tricky-javascript-interview-question-asked-by-google-and-amazon-48d212890703> - A Tricky JavaScript Interview Question Asked by Google and Amazon
...
* [karan/Projects](https://github.com/karan/Projects) ⭐ 47,874 | 🐛 123 | 📅 2024-08-14 : a large collection of small projects for beginners with
* [vicky002/1000-Projects](https://github.com/vicky002/1000_Projects) ⭐ 2,404 | 🐛 6 | 📅 2023-08-29 : Mega List of practical projects that one can solve in any programming language!
...
* [JS Project Guidelines](https://github.com/wearehive/project-guidelines) ⭐ 29,452 | 🐛 16 | 🌐 JavaScript | 📅 2024-12-09 : A set of best practices for JavaScript projects.
...
* [Directory of Online CS Courses](https://github.com/ossu/computer-science) ⭐ 208,051 | 🐛 25 | 🌐 HTML | 📅 2026-07-14 : Free online CS courses
* [Airbnb JS Style Guide](https://github.com/airbnb/javascript) ⭐ 148,145 | 🐛 162 | 🌐 JavaScript | 📅 2026-04-16 : A mostly reasonable approach to JavaScript
* [Directory of CS Courses (many with online lectures)](https://github.com/prakhar1989/awesome-courses) ⭐ 70,450 | 🐛 64 | 📅 2023-05-04 : Another online CS courses
* [Angular Style Guide](https://github.com/johnpapa/angular-styleguide/tree/master/a1) ⭐ 23,623 | 🐛 1 | 🌐 Vim Snippet | 📅 2026-04-30 : Officially endorsed style guide by John Pappa
* [Ruby coding style guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,551 | 🐛 74 | 📅 2026-07-20 : A community-driven Ruby coding style guide
...
* [github.com/chihungyu1116/leetcode-javascript](https://github.com/chihungyu1116/leetcode-javascript) ⭐ 842 | 🐛 9 | 🌐 JavaScript | 📅 2022-02-14
* [github.com/paopao2/leetcode-js](https://github.com/paopao2/leetcode-js) ⭐ 405 | 🐛 1 | 🌐 JavaScript | 📅 2018-03-04
* [github.com/paopao2/leetcode-js](https://github.com/paopao2/leetcode-js) ⭐ 405 | 🐛 1 | 🌐 JavaScript | 📅 2018-03-04
* [github.com/dnshi/Leetcode/tree/master/algorithms](https://github.com/dnshi/Leetcode/tree/master/algorithms) ⭐ 266 | 🐛 0 | 🌐 JavaScript | 📅 2023-12-26
* [github.com/hijiangtao/LeetCode-with-JavaScript/tree/master/src](https://github.com/hijiangtao/LeetCode-with-JavaScript/tree/master/src) ⭐ 206 | 🐛 1 | 🌐 JavaScript | 📅 2024-01-11
* [github.com/xiaoyu2er/leetcode-js](https://github.com/xiaoyu2er/leetcode-js) ⭐ 184 | 🐛 0 | 🌐 JavaScript | 📅 2018-01-05
* [github.com/loatheb/leetcode-javascript](https://github.com/loatheb/leetcode-javascript) ⭐ 134 | 🐛 2 | 🌐 JavaScript | 📅 2017-10-04
* [github.com/ecmadao/algorithms/tree/master/leetcode](https://github.com/ecmadao/algorithms/tree/master/leetcode) ⭐ 101 | 🐛 3 | 🌐 JavaScript | 📅 2022-07-12
* [github.com/zzxboy1/leetcode/tree/master/algorithms](https://github.com/zzxboy1/leetcode/tree/master/algorithms) ⭐ 64 | 🐛 0 | 🌐 JavaScript | 📅 2018-04-12
* [github.com/theFool32/LeetCode](https://github.com/theFool32/LeetCode) ⭐ 32 | 🐛 0 | 🌐 JavaScript | 📅 2018-09-13
* [github.com/jiangxiaoli/leetcode-javascript](https://github.com/jiangxiaoli/leetcode-javascript) ⭐ 21 | 🐛 0 | 🌐 JavaScript | 📅 2015-05-17
* [github.com/MrErHu/Leetcode/tree/master/algorithms](https://github.com/MrErHu/Leetcode/tree/master/algorithms) ⭐ 18 | 🐛 0 | 🌐 JavaScript | 📅 2018-01-10
* [github.com/EasyHard/leetcodejs](https://github.com/EasyHard/leetcodejs) ⭐ 15 | 🐛 0 | 🌐 JavaScript | 📅 2015-09-06
* [github.com/fa-ge/leetcode](https://github.com/fa-ge/leetcode) ⭐ 14 | 🐛 0 | 🌐 JavaScript | 📅 2021-03-02
* [github.com/AlanWei/LeetCode](https://github.com/AlanWei/LeetCode) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2021-05-12
* [github.com/ktorng/AlgoInterviewPrep/tree/master/misc/LeetCode](https://github.com/ktorng/AlgoInterviewPrep/tree/master/misc/LeetCode) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2020-10-11
* [github.com/didi0613/leetcode-javascript](https://github.com/didi0613/leetcode-javascript) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2016-09-19
* [github.com/kpman/leetcode/tree/master/src](https://github.com/kpman/leetcode/tree/master/src) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2017-07-08
* [github.com/bluesh/LeetCode](https://github.com/bluesh/LeetCode) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2019-03-05
* [github.com/iwantooxxoox/leetcode](https://github.com/iwantooxxoox/leetcode) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2017-03-07
* [github.com/KMBaby-zyl/leetcode/tree/master/Algorithms](https://github.com/KMBaby-zyl/leetcode/tree/master/Algorithms) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-13
* [github.com/zj972/leetcode/tree/master/code](https://github.com/zj972/leetcode/tree/master/code) ⭐ 5 | 🐛 0 | 🌐 Go | 📅 2018-10-15
* [github.com/cs1707/leetcode](https://github.com/cs1707/leetcode) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2016-09-23
* [github.com/imcoddy/leetcode](https://github.com/imcoddy/leetcode) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2015-11-21
* [github.com/xiaoliwang/leetcode/tree/master/iojs](https://github.com/xiaoliwang/leetcode/tree/master/iojs) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2016-02-22
* [github.com/karenpeng/leetCode](https://github.com/karenpeng/leetCode) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2016-02-23
* [github.com/LiuL0703/algorithm/tree/master/LeetCode/JavaScript](https://github.com/LiuL0703/algorithm/tree/master/LeetCode/JavaScript) ⭐ 2 | 🐛 13 | 🌐 JavaScript | 📅 2020-03-24
* [github.com/whwei/LeetCode](https://github.com/whwei/LeetCode) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2015-11-17
* [github.com/dieface/leetcode/tree/master/javascript](https://github.com/dieface/leetcode/tree/master/javascript) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2016-06-08
* [github.com/alenny/leetcode/tree/master/src](https://github.com/alenny/leetcode/tree/master/src) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2018-08-03
* [github.com/yuguo/LeetCode](https://github.com/yuguo/LeetCode) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2017-06-01
* [github.com/HandsomeOne/LeetCode/tree/master/Algorithms](https://github.com/HandsomeOne/LeetCode/tree/master/Algorithms) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2016-10-25
* [github.com/magicly/leetcode/tree/master/js](https://github.com/magicly/leetcode/tree/master/js) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2019-09-25
...
* [github.com/careercup/ctci/tree/master/javascript/lib/data-structures](https://github.com/careercup/ctci/tree/master/javascript/lib/data-structures) ⭐ 5,137 | 🐛 65 | 🌐 Java | 📅 2023-06-26
* [github.com/rohan-paul/Awesome-JavaScript-Interviews#collection-of-cracking-the-coding-interview-book-problem-solution](https://github.com/rohan-paul/Awesome-JavaScript-Interviews#collection-of-cracking-the-coding-interview-book-problem-solution) ⭐ 3,743 | 🐛 12 | 🌐 JavaScript | 📅 2024-02-29
* [github.com/careercup/CtCI-6th-Edition-JavaScript-ES2015](https://github.com/careercup/CtCI-6th-Edition-JavaScript-ES2015) ⭐ 836 | 🐛 19 | 🌐 JavaScript | 📅 2022-12-01
* [github.com/seemaullal/CrackingTheCodingInterview-JS](https://github.com/seemaullal/CrackingTheCodingInterview-JS) ⭐ 125 | 🐛 12 | 🌐 JavaScript | 📅 2024-11-09
* [github.com/ChirpingMermaid/CTCI](https://github.com/ChirpingMermaid/CTCI) ⭐ 13 | 🐛 0 | 🌐 JavaScript | 📅 2018-08-10
* [github.com/SashaBayan/CCI](https://github.com/SashaBayan/CCI) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2015-07-01
* [github.com/ktorng/AlgoInterviewPrep/tree/master/CrackingTheCodingInterview](https://github.com/ktorng/AlgoInterviewPrep/tree/master/CrackingTheCodingInterview) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2020-10-11
* [github.com/macalinao/node-ctci](https://github.com/macalinao/node-ctci) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2015-08-05
* [github.com/miguelmota/ctci-js](https://github.com/miguelmota/ctci-js) ⚠️ Archived
* [github.com/sharlatta/cracking](https://github.com/sharlatta/cracking) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2016-10-04
* [github.com/ammiranda/CrackingTheCodingInterview](https://github.com/ammiranda/CrackingTheCodingInterview) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2014-06-12
* [github.com/bryclee/ctci](https://github.com/bryclee/ctci) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2015-08-17
* [github.com/rcerf/MyCtci](https://github.com/rcerf/MyCtci) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2014-06-26
* [github.com/muddybarefeet/Cracking-the-Coding-Interview-Problems/tree/master/toyProblems](https://github.com/muddybarefeet/Cracking-the-Coding-Interview-Problems/tree/master/toyProblems) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2016-04-20
* [github.com/randy909/coding-interview/tree/master/cracking](https://github.com/randy909/coding-interview/tree/master/cracking) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2016-12-18
...
* [The CAP FAQ](https://github.com/henryr/cap-faq) ⭐ 859 | 🐛 6 | 📅 2023-07-14
